...
function addTheValues(a, b) {
    if (isNaN(a) || isNaN(b)) {
        addToPage("One of the parameters is not a number, when added they eqaul " + a + " " + b);
    } else {
        addToPage("Both of the parameters are numbers, when added they equal " + (a + b));
    }
}
...
scoreBasket();
scoreThree();
addToPage("Current score is " + score);
...
addToPage("Current value of number is : " + number);
...
addToPage("Current value of number is : " + number);
addToPage("Number = " + number + " doubleMyNumber is: " + doubleMyNumberArrow(number));
...
// See the amount of quarters inside the amount
// See the left over and assign it in a variable

// with the variable, see how many dimes and leave it as amount
// 
